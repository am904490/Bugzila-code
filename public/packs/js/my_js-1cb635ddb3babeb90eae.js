...
var selectElement = document.querySelector('#bug_bug_type');
selectElement.addEventListener('change', function (event) {
  ...
  if (inputValue == 'feature') {
    ...
    for (i = 0; i < feature.length; i++) {
      options = document.getElementById("bug_status");
      var option = document.createElement("option");
      options.value = document.getElementById("bug_status").value;
      debugger;
    ...
    for (i = 0; i < bug.length; i++) {
      ...
      var option = document.createElement("option");
      options.value = document.getElementById("bug_status").value;
      bug_status.options.add(options);
    }
  }
});
...
/******/ });
//# sourceMappingURL=my_js-1cb635ddb3babeb90eae.js.map